...
platform is assumed to be already running (see [`runbook-local-rancher-desktop.md`](../runbooks/runbook-local-rancher-desktop.md)).
...
[`runbook-local-rancher-desktop.md`](../runbooks/runbook-local-rancher-desktop.md) §6.)
